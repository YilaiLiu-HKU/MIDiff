...
def recover_traces( MEAN_FACTOR=1.2, output_suffix=""):
    ...
    image_list=np.load('/data/yilai/MiDiff/ckpt/ckpt/tiff_log_attnBoth/model038500.pt_samples_3000x256x160x1.npz')['arr_0']
    #import pdb;pdb.set_trace()
...
# 用法示例
    ...
    output_path = f"/data/yilai/MiDiff/ckpt/ckpt/tiff_log_attnBoth/recover_filted_{mean_factor}_38500.npz"
