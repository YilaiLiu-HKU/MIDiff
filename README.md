...
The sample is generated by randomly selecting five traces and shifting a subset of active category and POI one-hot positions along the last dimension. It is intended only as a runnable format example.
