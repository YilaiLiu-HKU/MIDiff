...
file = np.load(os.path.join(os.path.dirname(os.path.abspath(__file__)), "dataset/all_users_data_with8cluster.npz"), allow_pickle=True)
print(file.files)
...
def recover_traces(image_root, MEAN_FACTOR=1.2, output_suffix=""):
    ...
    image_list=np.load('/home/yilai/projects/poster/NetDiffus/ckpt/tiff/ema_0.9999_058000.pt_samples_3000x256x160x1.npz')['arr_0']
    #import pdb;pdb.set_trace()
...
# 用法示例
    ...
    with Pool(processes=cpu_count()) as pool:
        args_list = [(img_path, MEAN_FACTOR,None) for img_path in image_list]
    ...
    output_path = f"/home/yilai/projects/poster/NetDiffus/ckpt/tiff/recover_NEW.npz"
